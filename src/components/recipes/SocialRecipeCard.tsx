  ...
  return (
    <Card className="w-full max-w-[500px] bg-white">
      <CardContent className="p-4">
        ...
        <div
          className="relative aspect-square mb-4 rounded-md overflow-hidden cursor-pointer"
          onClick={() => navigate(`/recipe/homemade-pizza`)}
        >
